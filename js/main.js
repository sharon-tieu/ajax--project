...
var $allUlElements = document.querySelectorAll('ul');

function getGhibliCharacter(name) {

  var $ulTitle = document.createElement('li');
  ...
  xhr.addEventListener('load', function () {
    ...
    xhr3.addEventListener('load', function () {
      ...
      $liSpecies.setAttribute('class', 'font-comfortaa search-item');
  ...
  xhr.send();
  $getGhibli.reset();
  // console.log('event.target.closest(".search-item"):', event.target.closest('.search-item'));
  $allUlElements.textContent = '';
}
// getGhibliCharacter();
